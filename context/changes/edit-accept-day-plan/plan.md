...
- [x] 3.1 Lint czysty: `npm run lint` — 054b2e0
- [x] 3.2 Kontrola typów bez błędów: `npx astro check` — 054b2e0
- [x] 3.3 Build przechodzi: `npm run build` — 054b2e0
- [x] 3.4 Obie nowe trasy bez sesji odpowiadają 401 z `content-type: application/json` — 054b2e0
- [x] 3.5 `PATCH` z tytułem dłuższym niż 200 znaków odpowiada 400 — 054b2e0
